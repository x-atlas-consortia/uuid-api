...
DONORS_CYPHER = "match (d:Donor)<-[:ACTIVITY_OUTPUT]-(a)-[:ACTIVITY_INPUT]-(lab:Lab) return d.uuid, d.submission_id, d.doi_suffix_id, d.hubmap_id, lab.uuid, d.created_by_user_email, d.created_timestamp, d.created_by_user_displayname, d.created_by_user_sub"
SAMPLES_CYPHER = "match (s:Sample)<-[:ACTIVITY_OUTPUT]-(a)-[:ACTIVITY_INPUT]-(anc:Entity) return s.uuid, s.submission_id, s.doi_suffix_id, s.hubmap_id, anc.uuid, s.created_by_user_email, s.created_timestamp, s.created_by_user_displayname, s.created_by_user_sub, s.organ, s.specimen_type"
DATASETS_CYPHER = "match (ds:Dataset)<-[:ACTIVITY_OUTPUT]-(a)-[:ACTIVITY_INPUT]-(anc:Entity) return collect(anc.uuid) as ancestor_ids, ds.uuid, ds.doi_suffix_id, ds.hubmap_id, ds.created_by_user_email, ds.created_timestamp, ds.created_by_user_displayname, ds.created_by_user_sub"
