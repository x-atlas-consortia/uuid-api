...
To run tests, make sure the development dependencies are installed in your environment. You can install them via pip:

```bash
pip install -r src/requirements.dev.txt
```

Make sure Docker is running and then execute the `run_tests.sh` script:
